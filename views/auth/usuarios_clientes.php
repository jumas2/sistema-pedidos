...
<div class="page-header">
    ...
    <div class="header-right">
        <a href="<?= BASE_URL ?>?url=usuarios" class="btn-secondary-modern">
                    ...
                    <tbody>
                        <?php foreach ($clientesAsignados as $c): ?>
                            <tr>
                                ...
                                <td><?= $c['telefono'] ?></td>
                                <td>
		                         <a href="<?= BASE_URL ?>?url=usuarios/eliminarCliente/<?= $user['id'] ?>/<?= $c['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Remover este cliente?')">
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <?php if (count($clientesDisponibles) > 0): ?>
            <form method="POST" action="<?= BASE_URL ?>?url=usuarios/asignarCliente/<?= $user['id'] ?>">
                <div class="row">
                    <div class="col-md-8">
